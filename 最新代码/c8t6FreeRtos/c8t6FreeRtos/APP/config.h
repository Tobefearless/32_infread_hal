...
/***************************配置继电器端口引脚***************************/
...
#else
	#define HEAT_PORT          GPIOA //加热
	#define HUMI_PORT          GPIOA //补湿
	#define BREATH_PORT        GPIOA //换气
	#define SENSITIVE_PORT     GPIOB //感光
	#define WIND_PORT          GPIOB //匀风
	#define STERILIZE_PORT     GPIOB //消毒

	#define LIGHT_PORT         GPIOB //光照

	#define DRY_PORT           GPIOB //除湿
	...
	#define HEAT_PIN           GPIO_PIN_11  //加热
	#define HUMI_PIN           GPIO_PIN_12  //补湿
	#define BREATH_PIN         GPIO_PIN_15  //换气
	#define SENSITIVE_PIN      GPIO_PIN_3 //感光
	#define WIND_PIN           GPIO_PIN_4 //匀风
	#define STERILIZE_PIN      GPIO_PIN_5 //消毒
	#define LIGHT_PIN          GPIO_PIN_6 //光照
	#define DRY_PIN            GPIO_PIN_7 //除湿
#endif
